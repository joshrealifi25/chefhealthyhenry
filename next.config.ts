...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/recipes/grilled-peach-salad-with-marinated-chicken-blakc-rice-75hzb", destination: "/recipes/grilled-peach-salad-with-marinated-chicken-black-rice", statusCode: 301 },
      { source: "/recipes/grilled-peach-salad-with-marinated-chicken-blakc-rice", destination: "/recipes/grilled-peach-salad-with-marinated-chicken-black-rice", statusCode: 301 },
